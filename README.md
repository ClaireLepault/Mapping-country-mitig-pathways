...
A tutorial on systematic search on Scopus and Web of Science is already presented on Github : https://github.com/ClaireLepault/systematic-search-wos-scopus.
...
In each following folder, the files created during this step of the analysis are in the output folder. 
...
* [3_Topic_modeling](3_Topic_modeling) : seven notebooks detail  step-by-step the Non-Negative Matrix Factorization (NMF) approach and its parameter selection. 


* [4_Manual_treatment_topic_table](4_Manual_treatment_topic_table) : Input is the [table counting topic-papers association](3_Topic_modeling/Table_topics_count.csv). Topic "final names" are added manually. 
